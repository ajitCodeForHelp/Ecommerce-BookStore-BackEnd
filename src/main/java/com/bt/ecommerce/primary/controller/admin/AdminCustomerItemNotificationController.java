...
@Slf4j
@RestController
@RequestMapping("/admin/v1/CustomerItemNotification")
public class AdminCustomerItemNotificationController extends _BaseController {

    @TranslateResponseMessage
    @PostMapping("/save")
    protected ResponseEntity<ResponsePacket> save(@Valid @RequestBody CustomerItemNotificationDto.SaveCustomerItemNotification create) throws BadRequestException {
    ...
    protected ResponseEntity<ResponsePacket> saveLoggedInCustomerRequest(@Valid @RequestBody CustomerItemNotificationDto.SaveCustomerItemNotification create) throws BadRequestException {
